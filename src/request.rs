...
use crate::appendable_data::{
    self, AppendOnlyDataRef, AppendOnlyKind, Index, Owners, PubPermissions, UnpubPermissions, User, AppendOnlyData as AData
};
...
pub enum Request {
    ...
    /// Put a new AppendOnlyData into the network.
    PutAData {
